...
#if 1   // 20131215 hwpark. fix ASSERT
  /* PuPd setting */
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
#endif
...
#if 0   // 20131215 hwpark. fix ASSERT
//  CPAL_DMA_InitStructure.DMA_BufferSize = 1;
#else
  ...
  CPAL_DMA_InitStructure.DMA_BufferSize = 1;        // 20140826 hwpark.
